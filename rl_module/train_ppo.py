...
from .evaluation import evaluate_atari
        ...
        if (args.eval_interval is not None and len(episode_rewards) > 1
            ...
            if args.experiment == 'roboschool':
                eval_episode_rewards = evaluate(actor_critic, ob_rms, task_sequences, args.seed,
                             10, args.log_dir, device, obs_shape, task_idx)
            else:
                eval_episode_mean_rewards, eval_episode_max_rewards, eval_episode_min_rewards = evaluate_atari(actor_critic, ob_rms, task_sequences, args.seed,
                             10, args.log_dir, device, obs_shape, task_idx)
