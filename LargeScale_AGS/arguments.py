...
def get_args():
    ...
    parser.add_argument('--lamb', type=float, default=1, help='Lambda for gs, mas, rwalk, ewc, si, hat')
    ...
    parser.add_argument('--stop', default=100, type=int, help='(default=%(default)s)')
    parser.add_argument('--date', type=str, default='', help='(default=%(default)s)')
    parser.add_argument('--output', default='', type=str, required=False, help='(default=%(default)s)')
    parser.add_argument('--dataset', default='CUB200', type=str,
                        choices=['mini-Imagenet', 
                                 'tiny-Imagenet', 
                                 'CUB200', 
                                 'CIFAR10',
                                 'CIFAR100',
